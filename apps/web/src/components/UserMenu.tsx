      ...
      {isOpen && (
        ...
        >
          ...
          <div className="py-2">
            ...
            {monetizationEnabled && isFreshFromDB && planKey && planKey !== 'free' && (
              <Link
                to="/profile"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-3 px-4 py-2.5 text-sm transition-colors"
              ...
              >
                ...
                <span>{t('profile.billing.manageBilling')}</span>
              </Link>
            )}
            ...
            <Link
              ...
              style={{ color: 'var(--text-secondary)' }}
            >
              <svg className="w-5 h-5" style={{ color: 'var(--text-tertiary)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
